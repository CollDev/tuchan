                    ...
                    <li style="width: 100%; float: left; margin-right: -100%; position: relative; display: none;" class="">
                        <div class="content_section3">
                            <div class="layer_content">                        
                                ...
                                <div class="mode_fade">
                                    <a href="http://dev.micanal.pe/programa/insensato-corazon">
    ...
    <div class="mc_column mc_columnF">
        <div class="mc_column canal_data">
            <div class="mc_column item_canal_logo">
                <img src="http://dev.e.micanal.e3.pe/0/0/0/0/3/3454.fw" title="Te gustan nuestros programas? No te pierdas ni un solo minuto de tus programas, series, películas favoritas y mucho más." alt="Te gustan nuestros programas? No te pierdas ni un solo minuto de tus programas, series, películas favoritas y mucho más."> 

            </div>
            <div class="mc_column item_canal_desc">
                Te gustan nuestros programas? No te pierdas ni un solo minuto de tus programas, series, películas favoritas y mucho más.        
