...
<html lang="es">
    <head>
        ...
        <link href="/system/cms/themes/default/bootstrap/css/bootstrap.min.css?_=<?php echo $cache; ?>" rel="stylesheet">
        <link href="/system/cms/themes/default/js/tinytable/style.css?_=<?php echo $cache; ?>" rel="stylesheet">
        ...
        <link href="/system/cms/themes/default/css/styles.css?_=<?php echo $cache; ?>" rel="stylesheet">
