...
<form id="upload_form">
        <fieldset>
            ...
            <select id="lista_canales" name="canal">
            ...
            <input id="fecha_transmision_inicio" name="fecha_transmision_inicio" type="date" />
            <br>
            <label for="fecha_transmision_fin">Fecha de transmisión fin</label>
            <input id="fecha_transmision_fin" name="fecha_transmision_fin" type="date" />
            <br>
            ...
            <input id="personajes" name="personajes" type="text" />
            <br>
        </fieldset>
        <fieldset>
