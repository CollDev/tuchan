...
insert  into `default_cms_tags`(`id`,`tipo_tags_id`,`nombre`,`descripcion`,`alias`,`estado`,`fecha_registro`,`usuario_registro`,`fecha_actualizacion`,`usuario_actualizacion`,`estado_migracion`,`fecha_migracion`,`fecha_migracion_actualizacion`,`estado_migracion_sphinx`,`fecha_migracion_sphinx`,`fecha_migracion_actualizacion_sphinx`) values (1,1,'tematico video 1','tematico video 1','tematico-video-1',1,'2012-01-25 10:15:00',1,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL),(2,2,'personaje video 1','personaje video 1','personaje-video-1',1,'2012-01-25 10:15:00',1,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL),(3,1,'tematico x video 1','tematico x video 1','tematico-x-video-1',1,'2012-01-25 10:15:00',1,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `default_cms_usuario_rol_canales` (
  ...
  `fecha_actualizacion` datetime DEFAULT NULL,
  `usuario_actualizacion` int(11) DEFAULT NULL,
  PRIMARY KEY (`canales_id`,`usuarios_id`,`roles_id`),
  KEY `fk_table1_canal1_idx` (`canales_id`),
  KEY `fk_table1_usuario1_idx` (`usuarios_id`),
  KEY `fk_table1_rol1_idx` (`roles_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

/*Data for the table `default_cms_usuario_rol_canales` */

/*Table structure for table `default_cms_usuario_rol_canales_` */

DROP TABLE IF EXISTS `default_cms_usuario_rol_canales_`;

CREATE TABLE `default_cms_usuario_rol_canales_` (
  `user_id` int(11) NOT NULL,
  `group_id` int(11) NOT NULL,
  `canal_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `default_cms_usuario_rol_canales_` */

insert  into `default_cms_usuario_rol_canales_`(`user_id`,`group_id`,`canal_id`) values (3,4,1),(3,4,2);
...
insert  into `default_users`(`id`,`email`,`password`,`salt`,`group_id`,`ip_address`,`active`,`activation_code`,`created_on`,`last_login`,`username`,`forgotten_password_code`,`remember_code`) values (1,'glopez@idigital.pe','af3db9ac2af64d73f892e481170f88d0d4e7e385','d1f2b',1,'',1,'',1358180061,1360353368,'admin',NULL,'ce9c6b0d53b3e3380b0837186942ae386728ee4b'),(2,'csuazo@idigital.pe','794c086897ccee7f29c079611a0fcadc37780e90','afc8ab',3,'192.168.1.34',1,NULL,1358550539,1359060941,'cristian',NULL,NULL),(3,'jzambrano@idigital.pe','8561442bbaa114aee9c4f6f9024e65339559dd42','9a9820',4,'192.168.1.34',1,NULL,1358550679,1360353412,'jessenia',NULL,'e098cd0b492072fdd0bd78ad01039f2a497458a7'),(4,'cdepaz@idigital.pe','dc00475fe3449886608277973415af36ec4901fb','8963a3',5,'127.0.0.1',1,NULL,1359060477,1359060477,'cdepaz',NULL,NULL);
