...
insert  into `default_cms_categorias`(`id`,`nombre`,`alias`,`estado`,`fecha_registro`,`usuario_registro`,`fecha_actualizacion`,`usuario_actualizacion`,`status_migracion`,`fecha_migracion`,`fecha_migracion_actualizacion`,`categoria_id`) values (1,'Entretenimiento','entretenimiento',1,'2012-02-01 00:00:00',1,'2012-02-01 00:00:00',NULL,0,NULL,NULL,0),(2,'Deporte','deporte',1,'2012-02-01 00:00:00',1,'2012-02-01 00:00:00',NULL,0,NULL,NULL,0),(3,'Noticias','noticias',1,'2012-02-01 00:00:00',1,'2012-02-01 00:00:00',NULL,0,NULL,NULL,0),(4,'Música','musica',1,'2012-02-01 00:00:00',1,'2012-02-01 00:00:00',NULL,0,NULL,NULL,0),(5,'Gastronomía','gastronomia',1,'2012-02-01 00:00:00',1,'2012-02-01 00:00:00',NULL,0,NULL,NULL,0),(6,'Turismo','turismo',1,'2012-02-01 00:00:00',1,'2012-02-01 00:00:00',NULL,0,NULL,NULL,0),(7,'Series de TV','series-de-tv',1,'2012-02-01 00:00:00',1,'2012-02-01 00:00:00',NULL,0,NULL,NULL,1),(8,'Reality','reality',1,'2012-02-01 00:00:00',1,'2012-02-01 00:00:00',NULL,0,NULL,NULL,1),(9,'Novelas','novelas',1,'2012-02-01 00:00:00',1,'2012-02-01 00:00:00',NULL,0,NULL,NULL,1),(10,'Infantiles','infantiles',1,'2012-02-01 00:00:00',1,'2012-02-01 00:00:00',NULL,0,NULL,NULL,1),(11,NULL,NULL,0,NULL,NULL,NULL,NULL,0,NULL,NULL,1);
...
insert  into `default_cms_videos`(`id`,`tipo_videos_id`,`categorias_id`,`usuarios_id`,`canales_id`,`fuente`,`nid`,`titulo`,`alias`,`descripcion`,`fragmento`,`codigo`,`reproducciones`,`duracion`,`fecha_publicacion_inicio`,`fecha_publicacion_fin`,`fecha_transmision`,`horario_transmision`,`ubicacion`,`estado`,`estado_liquid`,`fecha_registro`,`usuario_registro`,`fecha_actualizacion`,`usuario_actualizacion`,`estado_migracion`,`fecha_migracion`,`fecha_migracion_actualizacion`,`estado_migracion_sphinx_tit`,`fecha_migracion_sphinx_tit`,`fecha_migracion_actualizacion_sphinx_tit`,`estado_migracion_sphinx_des`,`fecha_migracion_sphinx_des`,`fecha_migracion_actualizacion_sphinx_des`) values (1,1,1,3,1,3,NULL,'Video #1 - Canal 4','video-1-canal-4','Descripcion Video #1 Canal 4',1,NULL,NULL,NULL,'2012-06-12 10:00:00','2013-06-12 10:00:00','2012-06-13','09:00:00','Lima',1,NULL,'2012-06-12 10:00:00',3,NULL,NULL,0,NULL,NULL,0,NULL,NULL,0,NULL,NULL);

/*Table structure for table `default_cms_videos_` */

DROP TABLE IF EXISTS `default_cms_videos_`;

CREATE TABLE `default_cms_videos_` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID del Video',
  `tipo_videos_id` int(11) NOT NULL COMMENT 'ID del Tipo de Video',
  `categorias_id` int(11) NOT NULL,
  `usuarios_id` int(11) NOT NULL,
